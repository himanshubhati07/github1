...
output_dir = r"/home/himanshu.jangra/backendX/backend/outputs/7bbb5d2f-150e-4e57-9403-5a51efa3b558"
...
# API test results come from the xlsx report written in Step 16 — the single
# source of truth for final endpoint status (no intermediate log files).
logs_text = ""
